...
function handleButtonClick(questionNumber) {
    ...
    const responses = [
        " Please visit this website for testing your soil. https://www.kribhco.net/pages/services/soil.html
        Oh! do you know you can test your own soil using some kits? ",
